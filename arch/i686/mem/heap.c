...
void *kmalloc(size_t sz) { return kmallocInt(sz, 0, NULL); }

void *kmallocA(size_t sz) { return kmallocInt(sz, 1, NULL); }

void *kmallocP(size_t sz, void **phys) { return kmallocInt(sz, 0, phys); }

void *kmallocAp(size_t sz, void **phys) { return kmallocInt(sz, 1, phys); }

void kmallocSetAddress(uint32_t addr) { kmalloc_addr = addr; }
