...
void gdtInit()
{
    ...
    printf("[ GDT ] Base Low:    0x%x 0x%x 0x%x 0x%x 0x%x\n", gdt[0].baseLow, gdt[1].baseLow, gdt[2].baseLow, gdt[3].baseLow, gdt[4].baseLow);
    printf("[ GDT ] Base Mid:    0x%x 0x%x 0x%x 0x%x 0x%x\n", gdt[0].baseMid, gdt[1].baseMid, gdt[2].baseMid, gdt[3].baseMid, gdt[4].baseMid);
    printf("[ GDT ] Base High:   0x%x 0x%x 0x%x 0x%x 0x%x\n", gdt[0].baseHigh, gdt[1].baseHigh, gdt[2].baseHigh, gdt[3].baseHigh, gdt[4].baseHigh);
    printf("[ GDT ] Limit:       0x%x 0x%x 0x%x 0x%x 0x%x\n", gdt[0].limit, gdt[1].limit, gdt[2].limit, gdt[3].limit, gdt[4].limit);
    printf("[ GDT ] Access:      0x%x 0x%x 0x%x 0x%x 0x%x\n", gdt[0].access, gdt[1].access, gdt[2].access, gdt[3].access, gdt[4].access);
    printf("[ GDT ] Granularity: 0x%x 0x%x 0x%x 0x%x 0x%x\n\n", gdt[0].granularity, gdt[1].granularity, gdt[2].granularity, gdt[3].granularity, gdt[4].granularity);
