...
DESTDIR = build
INCLUDES = -Ilib/include -Iarch/i686 -Iarch/i686/mem -Iarch/i686/boot -Iarch/i686/shell -Iarch/i686/cpu -Iarch/i686/graphics -Iarch/i686/ps2 -Iarch/i686/system -Idrivers -Ifonts -Ikernel
...
version.h: 
	@echo "#define KERNEL_VERSION \"0.2.0.`date +%Y%m%d%H%M%S`\"" > $(VERSIONFILE)
